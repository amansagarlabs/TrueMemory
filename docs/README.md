...
- [Platform Strategy](./strategy/PLATFORM_STRATEGY.md)
- [Memory Architecture](./architecture/MEMORY_ARCHITECTURE.md)
- [Benchmark Plan](./benchmarks/BENCHMARK_PLAN.md)
- [Package Install Guide](./setup/README.md)

Use these files when updating positioning, architecture, or benchmark language.
