...
export class TrueMemory {
  ...
  remember(input: MemoryInput, options?: RequestOptions) { return this.request<{ saved: boolean; key: string; scope: string }>("/v1/memories", { method: "POST", body: JSON.stringify(input) }, options); }
