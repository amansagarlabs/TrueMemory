...
const entries: DocEntry[] = [
  ...
  { id: "verified", section: "History", title: "What is verified?", summary: "The repository is the historian; gaps are not filled with invented biography.", body: "The repository contains earlier TrueMemory, AmanAgentLab, and AmanCrawl vision documents as historical source material. The exact chronology of every experiment and the founder's personal motivations are not fully verified here and are intentionally marked unknown." },
];
