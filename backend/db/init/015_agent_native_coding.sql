...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'coding_agent_runs') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'coding_agent_steps') THEN
